...
css_addition = """
        ...
        .btn-align i[data-lucide] { width: 14px; height: 14px; }
"""
if '/* Lucide Vector Icons UI CSS */' not in html:
    html = html.replace('</style>', f'{css_addition}</style>')

# Replacements list (regex pattern, replacement string)
replacements = [
    # Main tools
    ...
    # Align Buttons (we have text_align_group, edit_text_align_group, and set_text_align_group)
